...
%argdel
$argadd forge.sh
$argadd buildtools/clean.sh
$argadd buildtools/build.sh
set stal=2
tabnew
tabnew
tabrewind
...
set winwidth=1
argglobal
if bufexists("buildtools/clean.sh") | buffer buildtools/clean.sh | else | edit buildtools/clean.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
set winwidth=1
argglobal
if bufexists("buildtools/build.sh") | buffer buildtools/build.sh | else | edit buildtools/build.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
set stal=1
badd +0 forge.sh
badd +0 buildtools/clean.sh
badd +0 buildtools/build.sh
